...
/* =========================================================
   ...
   Separate pharmacist notification state from Admin.
========================================================= */

const SEEN_ALERTS_KEY =
  "green-life-pharmacy-pharmacist-seen-alerts";
...
async function fetchPharmacistProfile(
  signal?: AbortSignal,
...
export default function PharmacistNavbar() {
  ...
  useEffect(() => {
    ...
    fetchPharmacistProfile(
      ...
      .catch((error) => {
        ...
        console.error(
          "Pharmacist navbar profile error:",
          error,
        );
      });
  ...
  /* =======================================================
     ...
     Reload on route change so changes from:
     - Sale
     - Stock adjustment
     - Purchase
     - Expiry status

     appear automatically after navigation.
  ======================================================= */
    ...
    fetchNavbarAlerts(
      ...
      .then(
        (
          ...
          /*
           * Remove old seen keys after
           * an alert is resolved.
           *
           * If it appears again later,
           * it becomes unread again.
           */
  ...
  /* =======================================================
     ...
     Opening notification bell marks
     currently active notifications as viewed.
  ======================================================= */
    ...
    <header className="sticky top-0 z-30 flex h-[64px] items-center justify-between border-b border-slate-200 bg-white px-4 sm:px-6">
      ...
      >
        ...
        <button
          ...
          className={`hidden items-center gap-2 rounded-full border px-4 py-2 text-xs font-medium transition sm:flex ${
            activeAlertCount >
            0
        ...
        <Link
          ...
          className="flex h-9 w-9 items-center justify-center rounded-full bg-[#078cc6] text-sm font-semibold text-white transition hover:bg-[#067eb3]"
        >
          {getInitial(
            profile.fullName,
          )}
        ...
        {alertsOpen ? (
          <div className="absolute right-10 top-[48px] z-50 w-[360px] max-w-[calc(100vw-24px)] overflow-hidden rounded-2xl border border-slate-200 bg-white shadow-xl sm:right-12">
            {/* HEADER */}
              ...
              {alertError ? (
                ...
                <div className="px-4 py-8 text-center">
                  ...
                  <p className="mt-1 text-xs text-slate-500">
                    Stock and expiry status are currently clear.
                  </p>
                </div>
              ) : (
                alerts.map(
                  (
                    ...
                    >
                      <div className="flex items-start gap-3">
                        <span
                          className={`mt-1.5 h-2.5 w-2.5 shrink-0 rounded-full ${getStatusDotClass(
                            alert.kind,
                          )}`}
                        />
            ...
            0 ? (
              <div className="grid grid-cols-2 border-t border-slate-100">
                <Link
                  ...
                  className="border-r border-slate-100 px-3 py-3 text-center text-xs font-medium text-sky-600 hover:bg-slate-50"
                >
                  Stock Alerts
                </Link>
                ...
                <Link
                  ...
                  className="px-3 py-3 text-center text-xs font-medium text-sky-600 hover:bg-slate-50"
                >
                  Expiry Alerts
                </Link>
              </div>
        ...
        {notificationsOpen ? (
          <div className="absolute right-10 top-[48px] z-50 w-[360px] max-w-[calc(100vw-24px)] overflow-hidden rounded-2xl border border-slate-200 bg-white shadow-xl sm:right-12">
            ...
            <div className="border-b border-slate-100 px-4 py-3">
              <div className="flex items-center justify-between">
                <div>
                  ...
                  <p className="mt-0.5 text-[11px] text-slate-500">
                    Current pharmacy alert notifications
                  </p>
                </div>
            ...
            <div className="max-h-[380px] overflow-y-auto">
              {alertError ? (
                ...
                <div className="px-4 py-8 text-center">
                  ...
                  <p className="mt-1 text-xs text-slate-500">
                    New stock or expiry problems will appear here.
                  </p>
                </div>
              ) : (
                alerts.map(
            ...
            {alerts.length >
            0 ? (
              <div className="border-t border-slate-100 bg-slate-50 px-4 py-2.5 text-center text-[11px] text-slate-500">
                All current notifications viewed
              </div>
            ) : null}
          </div>
        ) : null}
